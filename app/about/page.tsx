          ...
          <div className="flex flex-col items-start gap-6">
            ...
            <Reveal delay={0.05}>
              <h1 className="font-display text-4xl font-bold tracking-tight text-balance sm:text-5xl lg:text-[3.4rem] lg:leading-[1.1]">
                ...
                <span className="text-brand-accent">global ambitions</span>
              </h1>
            </Reveal>
            <Reveal delay={0.1}>
              ...
              <dl className="grid grid-cols-3 gap-6 pt-2">
                {stats.slice(0, 3).map((s) => (
                  <div key={s.label} className="flex flex-col gap-1">
                    <dd className="font-display text-2xl font-bold text-brand-accent sm:text-3xl">
        ...
        <div className="mx-auto w-full max-w-7xl px-5 sm:px-8">
          <Reveal className="mx-auto max-w-2xl text-center">
            <h2 className="font-display text-3xl font-bold tracking-tight sm:text-4xl">
              What we <span className="text-brand-accent">stand for</span>
            </h2>
          </Reveal>
          <div className="mt-12 grid gap-5 sm:grid-cols-2 lg:grid-cols-4">
            {values.map((v, i) => (
              <Reveal key={v.title} delay={0.06 * i}>
                <div className="flex h-full flex-col gap-4 rounded-2xl border border-border bg-card p-6 transition duration-300 hover:-translate-y-1 hover:border-brand-500/40">

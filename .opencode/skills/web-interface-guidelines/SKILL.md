...
description: Review UI code for Vercel Web Interface Guidelines compliance. Use when auditing accessibility, focus states, forms, animation, typography, content handling, images, performance, navigation, touch interaction, safe areas, dark mode, locale/i18n, hydration safety, and anti-patterns in frontend code.
...
Read files, check against rules below. Output concise but comprehensive.

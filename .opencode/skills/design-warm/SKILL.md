---
name: design-warm
description: Warm editorial design system for landing pages, blogs, and content-heavy sites. Use when the user wants a calm, earnest, tactile aesthetic with serif headlines, humanist sans body, terracotta accent, and generous whitespace. Rejects purple gradients, glassmorphism, and generic tech-startup sterile looks.
---

# Warm Editorial Design System

Reference for a terracotta-on-cream editorial aesthetic. Human, considered, slightly literary. Not tech-startup sterile, not luxury-brand cold. Feels like a well-designed magazine spread with a craft espresso on the side. Generous whitespace, slow rhythm, long-form reading is first-class.
